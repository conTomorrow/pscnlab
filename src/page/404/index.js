...
export default function Error() {
    ...
    return (
        <svg className="me404" viewBox="0 0 1000 480">
            <path id="cloud" className="st0" d="M658.4,345.2c-10.9,0-19.7-8.8-19.7-19.7c0-10.9,8.8-19.7,19.7-19.7h50.1c9.9-1.5,17.5-10,17.5-20.3
            ...
            <g id="triforce">
                <path id="zelda_stroke" className="st1" d="M138.4,59.5h36.9l-18.5,32L138.4,59.5z M193.8,91.5l18.5-32h-36.9L193.8,91.5z M175.4,123.5
                l18.5-32h-36.9L175.4,123.5z"/>
                <path id="zelda_dark_shadow" className="st0" d="M156.9,91.5l-18.5-32l18.5,10.7L156.9,91.5z M193.8,70.2l-18.5-10.7l18.5,32
                L193.8,70.2z M175.4,102.2l-18.5-10.7l18.5,32L175.4,102.2z"/>
                <path id="zelda_light_shadow" className="st2" d="M175.4,59.5l-18.5,10.7l-18.5-10.7H175.4z M175.4,59.5l18.5,10.7l18.5-10.7H175.4z
                M156.9,91.5l18.5,10.7l18.5-10.7H156.9z"/>
                <path id="zelda_highlight" className="st3" d="M150.6,66.6h12.5l-6.3,10.8L150.6,66.6z M193.8,77.4l6.3-10.8h-12.5L193.8,77.4z
            ...
            <g id="tetris-path">
                <g id="tetris">
                    <path id="tetris_stroke" className="st13"
                    ...
                    <path id="tetris_dark_shadow" className="st2"
                    ...
                    <path id="tetris_light_shadow" className="st0"
            ...
            <g id="moon">
                <path id="moon_body" className="st5" d="M641,34c26,0,47,21,47,47s-21,47-47,47s-47-21-47-47S615,34,641,34z"/>
            ...
            <g id="number_4">
                <path id="number_4_outline" className="st1" d="M379.5,235.5c0-4.9-3.9-9.1-8.7-9.1h-11.4v-72.5c0-9.1-8.5-15.7-17.6-15
                ...
                <path id="number_4_inner_lines" className="st14" d="M349,158v109.2 M345.9,147c-5.6,0-10.9,2.8-14,7.2l-47.1,69.5
                ...
                />
                <path id="number_4_dots" className="st10" d="M349,266c1.6,0,2.9,1.3,2.9,2.9c0,1.6-1.3,2.9-2.9,2.9c-1.6,0-2.9-1.3-2.9-2.9
            ...
            <g id="number_4_2">
                <path id="number_4_outline_2" className="st1" d="M627,235.5c0-4.9-3.9-9.1-8.7-9.1h-11.4v-72.5c0-9.1-8.5-15.7-17.6-15
            ...
            <g id="sword-path">
                <g id="sword">
                    ...
                    <polygon id="sword_blade" className="st1" points="437,199 446,187.3 387.3,138.9 366.3,136.7 372.2,154   "/>
